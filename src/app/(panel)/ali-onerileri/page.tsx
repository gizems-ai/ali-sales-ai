export default function AliOnerileriPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-lg font-semibold text-gray-900 mb-4">Ali Önerileri</h1>
      <div className="rounded-xl border border-dashed border-gray-200 bg-gray-50 p-12 flex flex-col items-center justify-center text-center">
        <p className="text-sm font-medium text-gray-400">Ali Önerileri yakında burada</p>
