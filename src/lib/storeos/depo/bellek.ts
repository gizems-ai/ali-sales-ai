...
export function varsayilanKurallar(): Kural[] {
  return [
    ...
    },
    {
      ...
      'Kosullar JSON': JSON.stringify([]),
      'Severity': 'low',
      'Gorev Basligi': '{kamera} goruntu kalitesi dustu',
      'Gorev Aciklamasi': 'Kare hizi {metadata.frameRate}. Analitik guvenilirligi azalabilir.',
    ...
    },
    {
      ...
      'Kosullar JSON': JSON.stringify([{ alan: 'metadata.occupancyRate', operator: '>=', deger: 0.85 }]),
      'Severity': 'medium',
      'Gorev Basligi': 'Magaza dolulugu %{metadata.occupancyRate} seviyesinde',
      'Gorev Aciklamasi': 'Yogunluk kapasiteye yaklasti. Giris yonlendirmesi ve ek personel degerlendir.',
      'Hedef Rol': 'magaza_muduru', 'Oncelik': 'normal',
